...
public class CreateRideGUI extends JFrame {
	...
	public CreateRideGUI(Driver d) {
		...
		datesWithEventsCurrentMonth=BLF.getThisMonthDatesWithRides("a","b",jCalendar.getDate());		
...
=======
				Ride r=BLF.createRide(fieldOrigin.getText(), fieldDestination.getText(), UtilDate.trim(jCalendar.getDate()), inputSeats, price, driver.getEmail());
